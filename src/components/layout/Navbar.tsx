        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center">
              ...
              <h1 className="text-xl font-bold text-gray-800">BDS</h1>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link to="/add-post" className="bg-gray-600 text-white hover:bg-gray-700 px-4 py-2 rounded-md text-sm font-normal transition-colors">
              Đăng tin
            </Link>
